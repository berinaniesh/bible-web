...
export const load: PageServerLoad = () => {
	...
	const aboutPoints = [
		...
		`Everything on this site is <a class="underline text-blue-600" target="blank" href="https://github.com/berinaniesh/bible-web">open sourced</a>. Forking and self hosting is not only allowed, but encouraged.`,
